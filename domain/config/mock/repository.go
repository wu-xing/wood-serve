...
// Source: C:\Users\chenf\go\src\github.com\wu-xing\wood-serve\domain\config\repository.go
...
import (
	...
	config "github.com/wu-xing/wood-serve/domain/config"
	reflect "reflect"
)
...
func (m *MockRepository) GetConfig() *config.AppConfig {
	m.ctrl.T.Helper()
